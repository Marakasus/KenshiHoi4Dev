...
NAI = {
	...
	DIPLOMACY_CREATE_FACTION_FACTOR = 0.05,		-- Factor for AI desire to create a new faction. Val < 1.0 makes it less likely to create than to join.
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 200, -- AI penalty for diplomatic faction acitons between nations of different ideologies
	...
	JOIN_ALLY_BASE_DESIRE = -300,					-- exactly what it says
